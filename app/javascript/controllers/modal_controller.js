...
export default class extends Controller {
  ...
  show() {
    ...
    this.panelTarget.classList.remove("opacity-0", "translate-y-4", "sm:translate-y-2", "scale-[0.98]")
  }
  ...
  close(event) {
    ...
    this.panelTarget.classList.add("opacity-0", "translate-y-4", "sm:translate-y-2", "scale-[0.98]")
